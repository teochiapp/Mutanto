...
<head>
<?php
$pageTitle = "Mutanto  | Let's talk";
$pageDescription = "UX UI design to take your digital project to the next level. Interested? Schedule a chat with the team 😎";
$pageKey = "Mutanto,User centered design,Services for Start Up,Digital design,Contact";
...
<body>
  ...
  <main>
    <style>
      .attFile::before {
        content: ' \f0c6 ATTACH A FILE' !important;
      }
    </style>
        ...
        <div class="mutanto__contacto-form-table">
          ...
          <div class="mutanto__contacto-form-table-form">
            <div class="mutanto__contacto-form-ajax hidden">
              ...
              <div class="mutanto__contacto-form-ajax-txt">Sending...</div>
            </div>
            <div class="mutanto__contacto-form-inputs">
              <p style="color:var(--blancomutanto)">We love new challenges.<br> Tell us what you need.</p>
              <div class="formbuilder-text form-group field-muntanto__contacto-form-input-name">
                <label for="muntanto__contacto-form-input-name" class="formbuilder-text-label">Name *</label>
                <input type="text" placeholder="Harry Potter" name="muntanto__contacto-form-input-name" access="false" id="muntanto__contacto-form-input-name" title="Enter your name" aria-required="true">
              ...
              <div class="formbuilder-text form-group field-muntanto__contacto-form-input-email">
                ...
                <input type="email" placeholder="harry@thechosenone.com" name="muntanto__contacto-form-input-email" access="false" id="muntanto__contacto-form-input-email" title="Enter your e-mail" aria-required="true">
                <div class="muntanto__contacto-form-err-email"></div>
                <label for="muntanto__contacto-form-input-know" class="formbuilder-text-label">How did you hear about us?</label>
                <input type="text" placeholder="Through the Daily Prophet" name="muntanto__contacto-form-input-know" access="false" id="muntanto__contacto-form-input-know" title="Feel free to fill it out if you'd like" aria-required="true">
                <label for="muntanto__contacto-form-input-name" class="formbuilder-textarea-label">Tell us about your project *</label>
              </div>
              <div class="formbuilder-textarea form-group field-muntanto__contacto-form-input-name">
                <textarea type="textarea" placeholder="My project is about the chamber of secrets and we need to know who the heir of Slytheryn is in order to save Hogwarts" class="form-control" name="muntanto__contacto-form-input-comments" access="false" id="muntanto__contacto-form-input-comments" title="Tell us something about your project" aria-required="true" rows="5" cols="40"></textarea>
            ...
            <button type="button" class="mutanto__elements-button extMobil" id="sendButtonM">Send</button>
          </div>
        </div>
        <div class="mutanto__contacto-send-set">
          <button type="button" class="mutanto__elements-button ext " id="sendButton">Send</button>
