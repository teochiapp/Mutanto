<section id="marketing-benefits" class="marketing-benefits">
  ...
  <div class="marketing-benefits__top">
    ...
    <div class="marketing-benefits__aside">
      <p class="marketing-benefits__description"><?php echo $marketingData['benefits']['description']; ?></p>

      <div class="marketing-benefits__actions">
        <a href="<?php echo $marketingData['benefits']['cta_primary']['url']; ?>" target="_blank" rel="noopener" class="cta-button cta-button--solid">
          <?php echo $marketingData['benefits']['cta_primary']['text']; ?>
        ...
        <a href="<?php echo $marketingData['benefits']['cta_secondary']['url']; ?>" target="_blank" rel="noopener" class="cta-button cta-button--outline">
          <?php echo $marketingData['benefits']['cta_secondary']['text']; ?>
