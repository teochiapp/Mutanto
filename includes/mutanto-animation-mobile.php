...
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Poppins:300&subset=latin">
...
if (reversed == null) { reversed = false; }
	...
	?>
	// text_Top
	this.title1 = new cjs.Text("<?php echo($text2)?>", "normal 700 40px 'Poppins'", "#FFFFFF");
	...
	this.timeline.addTween(cjs.Tween.get(this.title1).wait(50).to({text:"<?php echo($text1)?>"},0).wait(49).to({text:"<?php echo($text0)?>"},0).to({_off:true},1).wait(5));

	// text_lock
	this.text = new cjs.Text("<?php echo($text0)?>", "normal 300 22px 'Poppins'", "#FFFFFF");
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"<?php echo(URL_SITE)?>mutanto-home-animation/mobile/images/mutantoAnimationMobile_atlas_1.png", id:"mutantoAnimationMobile_atlas_1"}
	],
	preloads: []
};
...
function init() {
	...
	var comp=AdobeAn.getComposition("F98E8A917C0C2E4AB3A604D371A7980B");
	var lib=comp.getLibrary();
	try {
...
function handleComplete(evt,comp) {
	...
	exportRoot = new lib.mutantoAnimationMobile();
