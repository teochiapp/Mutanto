<?php
$menuOptions = [
  "es" => ["Home", "Proyectos", "Servicios", "Mutateam", "Charlemos"],
  ...
  <div class="Site-interface">
    <div class="offcanvas">
      ...
      <nav class="offcanvas-nav">
        ...
        <div class="heder__mutanto-footer-nav">
          <div></div>
          <div>
            <?php
            $text = "<p>Tener ideas es fácil. Tener buenas ideas es un poco más difícil.<br>Llevarlas a cabo es el desafío, y para eso estamos.</p>";
            if ($language == "en") {
              $text = "<p>Generating ideas is easy. Crafting good ones is a bit trickier. <br>The real challenge lies in bringing them to life, and that's what we're here for.</p>";
            }
            echo ($text);
            ?>
          ...
          <style>
            .heder__mutanto-footer-nav-social-icons span {
              display: none;
            }
          </style>
          <div class="heder__mutanto-footer-nav-social-icons">
            <?php require_once(realpath($_SERVER['DOCUMENT_ROOT']  . "/includes/contact-icons.php")); ?>
          </div>
        </div>
      </nav>
    </div>
